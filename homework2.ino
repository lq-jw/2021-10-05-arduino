...
void Dot () {ledcWriteTone(0, HIGH); delay (shortLightTime); ledcWriteTone(0, LOW); delay (codeSpaceTime);}
void Dash () {ledcWriteTone(0, HIGH); delay (longLightTime); ledcWriteTone(0, LOW);  delay (codeSpaceTime);}
